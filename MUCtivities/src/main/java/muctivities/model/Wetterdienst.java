...
public class Wetterdienst {
	...
	/**
	 * First two chars of weather icon Weather Icon format in responseBody is: ddx
	 * "d" represents a decimal and "x" is either character 'd' (day) or 'n' (night)
	 * 
	 * @param responseBody Response as json
	 * @return Returns weather icon as decimal consisting of the first two
	 *         characters
	 */
