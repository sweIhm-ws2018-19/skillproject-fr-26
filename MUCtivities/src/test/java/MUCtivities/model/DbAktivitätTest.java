...
public class DbAktivitätTest {

	@Test
	public void testGetDatabaseEntries() {
		List<Activity> activities;
		try {
			activities = DbAktivität.getDatabaseEntries();
	...
	public void testReadFile() {
		try {
			String fileContent = DbAktivität.readFile();
	...
	public void testParseJSONObject() {
		...
		"    \"info\": \"asdf\"\r\n" + 
		"  },\r\n");
		Activity activity = DbAktivität.parseJSONObject(exampleFromDatabase);
	...
	public void suggestionOfActivities() throws JSONException, IOException {
		List<Activity> suggestions = DbAktivität.suggestionOfActivities(true, true, "spaß");
